...
# Datos del problema
prioridad = [5, 3, 4, 1]  # p[i]: prioridad de cada especialidad
pacientes = [20, 15, 25, 18]  # d[i]: pacientes en lista de espera
capacidad = [
...
recursos_por_paciente = [2, 3, 1, 4]  # r[i]: recursos necesarios por paciente de especialidad i
